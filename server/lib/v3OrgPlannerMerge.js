...
function mergeDdEngine(exEngine, inEngine) {
  ...
  return {
    ...
    district_fallbacks: mergeById(ex.district_fallbacks, inn.district_fallbacks),
    ...
    authority_defaults_meta: { ...(ex.authority_defaults_meta || {}), ...(inn.authority_defaults_meta || {}) },
    economics: {
      targetMarginPct:
